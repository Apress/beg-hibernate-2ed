...
Compile the classes in the directory with the ant compile task, or "ant compile" from the command line. To run the example, use "ant annotationsExample" (which also will compile the classes).
